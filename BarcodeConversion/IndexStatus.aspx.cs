...
namespace BarcodeConversion
{
    public partial class IndexStatus : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Error-22: Issue occured while loading this page. Contact your system admin."
        ...
        protected void reset_Click(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Error-23: Issue occured while attempting reset. Contact your system admin." +
                                    System.Environment.NewLine + ex.Message);
            }
        }
        ...
        private Dictionary<int, string> populateJobsList()
        {
            ...
            {
                throw new Exception("Error-24: Issue occured while attempting to populate jobs dropdown. Contact system admin." +
                                    System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void onSelectedChange(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Error-25: Issue occured while attempting to process filter entries. Contact system admin." +
                                    System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void onSelectWhen(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Error-26: Issue occured while attempting to process filter entries. Contact system admin." +
                                    System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Error-27: Issue occured while attempting to process filter entries. Contact system admin." +
                                       System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void pageChange_Click(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                throw new Exception("Error-28: Issue occured while attempting to change page & process filter entries. Contact system admin." +
                                       System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void getIndexes(string jobAbb, string who, string when, string what)
        {
            ...
            {
                throw new Exception("Error-29: Issue occured while attempting to process filter entries. Contact system admin." +
                                       System.Environment.NewLine + ex.Message);
            }
            catch (Exception ex)
            {
                throw new Exception("Error-30: Date fields required!." +
                                       System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void onSelectedRecordsPerPage(object sender, EventArgs e)
        {
            ...
            {
                throw new Exception("Error-30: Issue occured while attempting to display requested number of records. Contact your system admin." +
                                    System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void rowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                throw new Exception("Error-31. Contact system admin." + System.Environment.NewLine + ex.Message);
            }
        }
        ...
        protected void gridView_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            {
                throw new Exception("Error-32: Issue occured while attempting to sort table." +
                                    System.Environment.NewLine + ex.Message);
            }
        }
        ...
        private string GetSortDirection(string column)
        {
            ...
            {
                throw new Exception("Error-33: Contact system admin." +
                    System.Environment.NewLine + ex.Message);
            } 
        }
    }
